package edu.nuaa.itstack.chat.ui.view.chat.element.group_bar_chat;

import edu.nuaa.itstack.chat.ui.util.DateUtil;
import edu.nuaa.itstack.chat.ui.util.Ids;
import edu.nuaa.itstack.chat.ui.view.chat.data.RemindCount;
import edu.nuaa.itstack.chat.ui.view.chat.data.TalkBoxData;
...
public class ElementTalk {
    ...
    public ElementTalk(String talkId, Integer talkType, String talkName, String talkHead, String talkSketch, Date talkDate) {
        pane = new Pane();
        pane.setId(Ids.ElementTalkId.createTalkPaneId(talkId));//对话ID
        ...
        msgRemind.setText("");//目前未设置 后续可以通过ElementTalk获取msgRemind来设置
